...
const p1Utilities = require('./p1Utilities');

const { createGatewayUserIfNoMatches , buildUserCreateBody } = p1Utilities;
...
const userBody = buildUserCreateBody(username, userEmail, populationID, gatewayID, userTypeID);
